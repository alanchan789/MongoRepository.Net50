namespace MongoRepository
{
        ...
        where T : IEntity<TKey>
    {
        ...
        public virtual bool Exists => collection.Exists();

        /// <summary>
        /// Gets the name of the collection as Mongo uses.
        /// </summary>
        /// <value>The name of the collection as Mongo uses.</value>
        public virtual string Name => collection.Name;

        /// <summary>
        /// Drops the collection.
        /// </summary>
        public virtual void Drop() => collection.Drop();
        ...
        public virtual bool IsCapped() => collection.IsCapped();
        ...
        public virtual void DropIndex(string keyname) => DropIndexes(new string[] { keyname });
        ...
        public virtual void DropIndexes(IEnumerable<string> keynames) => collection.DropIndex(keynames.ToArray());
        ...
        /// </remarks>
        public virtual void EnsureIndex(string keyname) => EnsureIndexes(new string[] { keyname });
        ...
        /// This is a convenience method for EnsureIndexes(IMongoIndexKeys keys, IMongoIndexOptions options).
        /// </remarks>
        public virtual void EnsureIndex(string keyname, bool descending, bool unique, bool sparse) => EnsureIndexes(new string[] { keyname }, descending, unique, sparse);
        ...
        /// Index will be ascending order, non-unique, non-sparse.
        /// </remarks>
        public virtual void EnsureIndexes(IEnumerable<string> keynames) => EnsureIndexes(keynames, false, false, false);
        ...
        /// </remarks>
        public virtual void EnsureIndexes(IMongoIndexKeys keys, IMongoIndexOptions options) => collection.CreateIndex(keys, options);
        ...
        public virtual bool IndexExists(string keyname) => IndexesExists(new string[] { keyname });
        ...
        /// <param name="keynames">The indexed fields.</param>
        /// <returns>Returns true when the indexes exist, false otherwise.</returns>
        public virtual bool IndexesExists(IEnumerable<string> keynames) => collection.IndexExists(keynames.ToArray());
        ...
        public virtual ValidateCollectionResult Validate() => collection.Validate();
        ...
        /// <remarks>You will need to reference MongoDb.Driver.</remarks>
        public virtual CollectionStatsResult GetStats() => this.collection.GetStats();
        ...
        public virtual GetIndexesResult GetIndexes() => collection.GetIndexes();


        public void ReIndex() => collection.ReIndex();


        public long GetTotalDataSize() => GetStats().DataSize;

        public long GetTotalStorageSize() => GetStats().StorageSize;
    }
